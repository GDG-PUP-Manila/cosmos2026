...
const SOCIAL_LINKS = [
  {
    ...
    icon: (
      <Linkedin className="h-[28px] w-[28px] stroke-[1.9]" aria-hidden="true" />
    ),
  },
  {
    label: "Instagram",
    ...
    icon: (
      <Instagram
        className="h-[28px] w-[28px] stroke-[1.9]"
        aria-hidden="true"
      />
    ),
  },
  {
    ...
    icon: (
      <Facebook className="h-[28px] w-[28px] stroke-[1.9]" aria-hidden="true" />
    ),
  },
  {
    label: "TikTok",
  ...
  },
  {
    ...
    icon: (
      <Github className="h-[28px] w-[28px] stroke-[1.9]" aria-hidden="true" />
    ),
  },
  {
    label: "YouTube",
    ...
    icon: (
      <Youtube className="h-[28px] w-[28px] stroke-[1.9]" aria-hidden="true" />
    ),
  },
  {
    label: "Email",
    ...
    icon: (
      <Mail className="h-[28px] w-[28px] stroke-[1.9]" aria-hidden="true" />
    ),
  },
];
...
export default function FooterSection() {
  return (
    <footer className="relative overflow-hidden bg-[#030712] px-6 pb-12 pt-14 text-center text-[#95a7c5] sm:px-10 sm:pt-16 lg:px-14 lg:pt-20 lg:text-left">
      <div className="mx-auto w-full max-w-[1380px]">
        <div className="grid gap-9 lg:grid-cols-[1.55fr_1fr_1fr_1fr] lg:gap-10">
          <section>
            ...
            <p className="mt-2 lg:mt-3 max-w-[330px] text-center text-[0.83rem] leading-[1.4] tracking-[0.01em] text-[#8e9ebc] mx-auto lg:mx-0 lg:text-justify">
              GDG PUP is a student-led technology community supported by Google.
              We exist to grow the next generation of developers, designers, and
              innovators through events, workshops, and collaborative projects
              that bridges the gap between theories to practice.
            </p>

            <ul className="mt-5 flex flex-wrap items-center justify-center gap-2 text-[#f2f6ff] lg:justify-start">
          ...
          <section>
            ...
            <ul className="mt-5 space-y-4 text-[0.83rem] font-light tracking-[0.01em] text-[#95a7c5]">
              <li>
                <span className="block text-[#667d9e] text-[0.7rem] uppercase font-medium tracking-wider mb-1">
                  Design
                </span>
                <a
                  href="https://www.linkedin.com/in/nyzel-cayat0/"
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <li>
                ...
                <div className="flex flex-col space-y-2">
                  ...
                  <a
                    href="https://www.linkedin.com/in/erwin-daguinotas"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="transition-colors duration-200 hover:text-[#d8e7ff]"
                  >
                  ...
                  <a
                    href="https://www.linkedin.com/in/delatorrecj/"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="transition-colors duration-200 hover:text-[#d8e7ff]"
                  >
