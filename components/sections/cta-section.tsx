...
export default function CtaSection() {
  ...
  return (
    <section
      id="cta"
      className="relative overflow-hidden px-4 py-16 text-white sm:py-20 md:px-6 md:py-24"
    >
      <Image
        draggable={false}
        src="/assets/CTA/BG-CTA.webp"
      ...
      <div className="relative z-10 mx-auto mt-[5.5rem] w-full max-w-[920px] rounded-[26px] border border-white/60 bg-[linear-gradient(180deg,rgba(4,10,33,0.62),rgba(2,7,26,0.62))] px-5 pb-10 pt-16 text-center font-sans shadow-[0_0_0_1px_rgba(255,255,255,0.1),0_28px_70px_rgba(2,10,38,0.58)] sm:px-9 sm:pb-12 sm:pt-20 md:mt-24 md:px-14 md:pb-14">
        <div
          className="pointer-events-none absolute left-1/2 top-0 z-[3] w-[126px] -translate-x-1/2 -translate-y-[69%] sm:w-[148px] md:w-[164px] lg:w-[176px]"
          aria-hidden="true"
        >
          <Image
            draggable={false}
        ...
        >
          We built COSMOS because world-class tech education belongs to
          everyone. Regardless of where you&apos;re from, what you study, or
          what you already know. Every event we organize is one step closer to
          making that real.
        </p>
